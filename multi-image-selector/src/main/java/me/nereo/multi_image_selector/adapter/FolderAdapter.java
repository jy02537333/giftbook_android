...
public class FolderAdapter extends BaseAdapter {
        ...
        if (holder != null) {
            if(i == 0){
                ...
                if(mFolders.size()>0){
                    ...
                    if (f != null) {
                        MyImgLoadTool.loadLocalImg
                        (mContext,new File(f.cover.path)
                                ,R.drawable.mis_default_error,holder.cover
                                ,R.dimen.mis_folder_cover_size, R.dimen.mis_folder_cover_size,null);
                    }else{
    ...
    class ViewHolder{
        ...
        void bindData(Folder data) {
            ...
            if (data.cover != null) {
                // 显示图片
                MyImgLoadTool.loadLocalImg(mContext
                        ,new File(data.cover.path)
                        ,R.drawable.mis_default_error,cover
                        ,R.dimen.mis_folder_cover_size, R.dimen.mis_folder_cover_size,null);
            }else{
