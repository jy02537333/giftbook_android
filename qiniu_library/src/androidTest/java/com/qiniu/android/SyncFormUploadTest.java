...
//        Assert.assertEquals(info.toString(), expectKey, key);
    ...
    public void testIpBack() throws Throwable {
        ServiceAddress s = new ServiceAddress("http://upwelcome.qiniu.com", Zone.zone1.upHost("").backupIps);
        Zone z = new FixedZone(s, Zone.zone1.upHostBackup(""));
    ...
    public void testDnsHijacking() throws Throwable {
        ServiceAddress s = new ServiceAddress("http://uphijacktest.qiniu.com", Zone.zone1.upHost("").backupIps);
        Zone z = new FixedZone(s, Zone.zone1.upHostBackup(""));
        Configuration c = new Configuration.Builder()
                .zone(z)
                .build();
