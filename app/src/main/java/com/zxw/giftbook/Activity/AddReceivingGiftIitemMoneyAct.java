...
public class AddReceivingGiftIitemMoneyAct extends MyBaseActivity {
    ...
    Handler mHandler=new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if(msg.what== MyPullToRefreshBaseFragment.GET_ADD_CODE)
            {
                ...
                int ret=messageHandlerTool.handler(msg,AddReceivingGiftIitemMoneyAct.this);
                if(ret==1)
                {
                    ToastShowTool.myToastShort(AddReceivingGiftIitemMoneyAct.this,"添加成功！");
                    setResult(1);
                    finish();
                }else
                {
                    ToastShowTool.myToastShort(AddReceivingGiftIitemMoneyAct.this,"添加失败！");
                }
                isSubmit=false;
            }else if(msg.what==MyPullToRefreshBaseFragment.GET_DATA_CODE) {
                MessageHandlerTool messageHandlerTool = new MessageHandlerTool();
                String data = messageHandlerTool.handlerData(msg, AddReceivingGiftIitemMoneyAct.this);
                if (data.length() > 0) {
                    try {
                ...
                GifttypeEntity obj=(GifttypeEntity)messageHandlerTool.handlerObject(msg,type,AddReceivingGiftIitemMoneyAct.this);
                if(obj!=null)
                {
            ...
            else if(msg.what==GET_GROUP_MEMBER_CODE)
            {
                ...
                List<GroupmemberEntity> data =(List<GroupmemberEntity>)
                        messageHandlerTool.handlerObject(msg,type, AddReceivingGiftIitemMoneyAct.this);
            ...
            ProgressDialogTool.getInstance(AddReceivingGiftIitemMoneyAct.this).dismissDialog();
        }
    };
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.a_add_receiving_gift_item_money);
    ...
    public void submit()
    {
        ...
        {
            ToastShowTool.myToastShort(this,"请输入礼金金额！");
            return ;
        }
        ...
        ProgressDialogTool.getInstance(AddReceivingGiftIitemMoneyAct.this).showDialog("加载中...");
    ...
    public void getDropDownData()
    {
        ...
        ProgressDialogTool.getInstance(AddReceivingGiftIitemMoneyAct.this).showDialog("提交中...");
        ...
        tool.showDialog("选择分组", sidekickerGroups, 1,
                this, null, new DropDownBoxTool.Callback() {
                    ...
                    public void complate(String key, String value) {
                        ...
                        ProgressDialogTool.getInstance(AddReceivingGiftIitemMoneyAct.this).showDialog("获取收礼人");
