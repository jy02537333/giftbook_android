...
import com.zxw.giftbook.adapter.ReceivesGiftAffairAdapter;
...
public class ReceivingGIftAffairFragment extends MyPullToRefreshBaseFragment {

    TitleBar titleBar;
    View view;
    AppServerTool mServicesTool;
    TextView numTv,moneyTv;
    ReceivesGiftAffairAdapter adapter;
    ...
    Handler mHandler=new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            if(msg.what==GET_DATA_CODE)
            {
                ...
                MessageHandlerTool.MessageInfo msgInfo = messageHandlerTool.handler(msg,ReceivingGIftAffairFragment.this,adapter,type);
                int num=0;
                double money=0.0d;
    ...
    public void initView()
    {
        ...
        listView=(SwipeRecyclerView)view.findViewById(R.id.f_receiving_gift_lv);
    ...
    void initTool()
    {
        ...
        adapter=new ReceivesGiftAffairAdapter(this);
