...
public class ZxingQRImgTool {

    public static Bitmap createQRImage(Activity context, String data, Bitmap logoBm) {
        ...
        try {
            ...
            int widthPix = context.getWindowManager().getDefaultDisplay()
                    .getWidth();
