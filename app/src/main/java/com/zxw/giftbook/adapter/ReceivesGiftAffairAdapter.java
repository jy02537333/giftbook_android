...
public class ReceivesGiftAffairAdapter extends MyBaseAdapter<ReceivingGiftEntity> {
    List<ReceivingGiftEntity> list;
    LayoutInflater inflater;
    ReceivingGIftAffairFragment mContext;
    public ReceivesGiftAffairAdapter(ReceivingGIftAffairFragment context)
    {
