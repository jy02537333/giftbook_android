package pri.zxw.library.refresh_tool;
...
import pri.zxw.library.refresh_tool.footerView.BaseFooterView;
...
public class SwipeRecyclerView extends FrameLayout
    ...
    private void setupSwipeRecyclerView() {
        ...
        mRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.l_swipe_recycler_view_lay);
        recyclerView = (RecyclerView) view.findViewById(R.id.l_swipe_recycler_view);
